...
interface INexusYieldManager {
    ...
    function initialize(ISatoshiCore satoshiCore_, address portal) external;
    ...
    function oracle(uint64 chainID, address asset) external view returns (IPriceFeedAggregator);
