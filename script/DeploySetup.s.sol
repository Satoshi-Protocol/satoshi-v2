...
contract Deployer is Script, IERC2535DiamondCutInternal {
    ...
    function _deployBorrowerOperationsFacet() internal returns (address, bytes4[] memory) {
        ...
        selectors[0] = IBorrowerOperationsFacet.isApprovedDelegate.selector;
        selectors[1] = IBorrowerOperationsFacet.setDelegateApproval.selector;
        selectors[2] = IBorrowerOperationsFacet.addColl.selector;
        selectors[3] = IBorrowerOperationsFacet.adjustTrove.selector;
        selectors[4] = IBorrowerOperationsFacet.closeTrove.selector;
        selectors[5] = IBorrowerOperationsFacet.fetchBalances.selector;
        ...
        selectors[8] = IBorrowerOperationsFacet.openTrove.selector;
        selectors[9] = IBorrowerOperationsFacet.removeTroveManager.selector;
        selectors[10] = IBorrowerOperationsFacet.repayDebt.selector;
        selectors[11] = IBorrowerOperationsFacet.setMinNetDebt.selector;
        selectors[12] = IBorrowerOperationsFacet.withdrawColl.selector;
        selectors[13] = IBorrowerOperationsFacet.withdrawDebt.selector;
        selectors[14] = IBorrowerOperationsFacet.checkRecoveryMode.selector;
        selectors[15] = IBorrowerOperationsFacet.getCompositeDebt.selector;
        selectors[16] = IBorrowerOperationsFacet.minNetDebt.selector;
        selectors[17] = IBorrowerOperationsFacet.troveManagersData.selector;
        vm.stopBroadcast();
